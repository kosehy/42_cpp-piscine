...
int		ClapTrap::getMhp(void) const { return (_maxhp); };
int		ClapTrap::getEp(void) const { return (_ep); };
int		ClapTrap::getMep(void) const { return (_maxep); };
int		ClapTrap::getLvl(void) const { return (_lvl); };
int		ClapTrap::getMad(void) const { return (_mad); };
int		ClapTrap::getRad(void) const { return (_rad); };
int		ClapTrap::getAdr(void) const { return (_adr); };
