...
Bureaucrat	OfficeBlock::ptSigner(void) { return (*_signer); }
Bureaucrat	OfficeBlock::ptExecuter(void) { return (*_executer); }

/* Set Functions */
void	OfficeBlock::setIntern(Intern &obj) { this->_intern = &obj; }
void	OfficeBlock::setSigner(Bureaucrat &obj) { this->_signer = &obj; }
void	OfficeBlock::setExecuter(Bureaucrat &obj) { this->_executer = &obj; }
