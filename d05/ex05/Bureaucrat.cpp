...
Bureaucrat::Bureaucrat(void) : _name("sko"), _grade(1) {}
...
void	Bureaucrat::executeForm(Form const &form)
{
	...
	{
		std::cout << this->_name << "(B) executes " << form.getName() << std::endl;
		form.execute(*this);
	} else
		std::cout << this->_name << "(B) grade (" << this->_grade << ") is too lower than " \
		<< form.getExeGrade() << std::endl;
}
